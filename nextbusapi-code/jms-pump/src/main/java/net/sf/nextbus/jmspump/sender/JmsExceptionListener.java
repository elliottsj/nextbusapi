...
/**
 * A simple JmsException listener that delegates to SLF4J
 * @author jrd
 */
public class JmsExceptionListener implements javax.jms.ExceptionListener {
     final Logger log = LoggerFactory.getLogger(JmsExceptionListener.class);

    public void onException(JMSException jmse) {
        log.error("JmsExceptionListener", jmse);
    }
}
